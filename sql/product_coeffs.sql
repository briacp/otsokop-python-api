SELECT
    ...
    p.deref,
    t.amount / 100 AS tax,
    t.amount / 100 * p.base_price AS tax_amount,
    coeff_1.value * p.base_price AS coeff_1_amount,
    coeff_2.value * p.base_price AS coeff_2_amount,
    coeff_3.value * p.base_price AS coeff_3_amount,
    coeff_4.value * p.base_price AS coeff_4_amount,
    coeff_5.value * p.base_price AS coeff_5_amount,
    concat_ws(
        ",",
        coeff_1.name,
        coeff_2.name,
